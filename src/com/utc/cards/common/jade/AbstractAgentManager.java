...
public abstract class AbstractAgentManager
{
    ...
    protected void startAgents(final Activity activity,
	    final RuntimeCallback<AgentController> agentStartupCallback,
	    final Class[] clazzs, String host, String port)
    {
    ...
    protected void startAgent(final Class<? extends Agent> agentClass,
	...
	_microRuntimeServiceBinder.startAgent(agentClass.getSimpleName(),
		...
		new RuntimeCallback<Void>() {
		    ...
		    {
			_log.info("Successfully start of the "
				+ agentClass.getName() + "...");
			_readyAgents++;
	...
	if (!MicroRuntime.isRunning())
	{
	    _microRuntimeServiceBinder.startAgentContainer(profile,
			...
			public void onSuccess(Void thisIsNull)
			{
			    ...
			    {
				startAgent(agentClass, activity,
