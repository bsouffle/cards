...
public class CardsActivity extends Activity
{
    ...
    private abstract class AgentStartupListener implements AgentActivityListener
    {
    ...
    private void setIpAddress()
    {
        ...
        String ip = settings.getString(HOST_IP, settings.getString(LOCAL_IP, ""));
    ...
    public void playerMode(View view)
    {
        ...
        if (ipsValids)
        {
            log.info("connectPlayerMode() : local: " + localIp + ", host: " + hostIp);
            ...
            AgentActivityListener playerStartupListener = new AgentStartupListener()
            {
                ...
                {
                    Intent intent = new Intent(CardsActivity.this, PlayerMenuActivity.class);
                    startActivityForResult(intent, PLAYER_REQUEST);
                }
            };
            PlayerAgentManager.instance().startAgents(this, settings.getString(GMAIL, ""), playerStartupListener);
        }
        else
        {
    ...
    public void hostMode(View view)
    {
        ...
        if (ipsValids)
        {
            ...
            AgentActivityListener hostStartupListener = new AgentStartupListener()
            {
                ...
                public void onAllAgentsReady()
                {
                    Intent intent = new Intent(CardsActivity.this, TableSelectGameActivity.class);
                    startActivityForResult(intent, HOST_REQUEST);
                }
            };
            HostAgentManager.instance().startAgents(this, null, hostStartupListener);
        }
        else
        {
            log.info("ips invalid");
            Utils.showAlertDialog(CardsActivity.this, "Adresse IP invalide", false);
        }
    }
