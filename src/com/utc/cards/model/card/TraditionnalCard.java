...
public class TraditionnalCard extends Card
{
    ...
    private TraditionnalCardNames _type;
    ...
    public TraditionnalCard(TraditionnalCardNames traditionnalCardName, Color color, int resourceId)
    {
        ...
        this._color = color;
        this._type = traditionnalCardName;
    }

    public TraditionnalCardNames getType()
    {
        return _type;
    }

    public void setType(TraditionnalCardNames _type)
    {
        this._type = _type;
    }
    ...
    {
        _AS("AS"), _2("2"), _3("3"), _4("5"), _5("5"), _6("6"), _7("7"), _8("8"), _9("9"), _10("10"), _J("J"), _Q("Q"), _K("K");
