...
public abstract class PlayerGameActivity<T extends IGame> extends Activity implements IPlayerGameActivity<T> 
{

	private static Logger _log = LoggerFactory.getLogger(PlayerGameActivity.class);
