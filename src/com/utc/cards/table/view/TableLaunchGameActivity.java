...
public class TableLaunchGameActivity extends Activity implements PropertyChangeListener
{
    ...
    public void updatePlayerList()
    {
        if (_listView == null)
        {
            ...
            _listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
            {
                ...
                {
                    _log.debug("Player clicked: " + _selectedGame.getPlayers().get(position).getName());
                }
            });
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_activated_1, _selectedGame.getPlayerNames());
