...
public class Utils
{
    ...
    /**
     * Reads into an existing Map from a Parcel that was stored using a String
     * array and a Bundle.
     * 
     * @param map
     *            the Map<String,V> that will receive the items from the parcel
     * @param in
     *            the Parcel to retrieve the map from
     * @param type
     *            the class used for the value objects in the map, equivalent to
     *            V.class before type erasure
     */
     ...
     * 
     * @param map
     *            the Map<String,V> to store in the parcel
     * @param in
     *            the Parcel to store the map in
     */
